...
class SepaDD(SepaPaymentInitn):
    ...
    def add_payment(self, payment):
        ...
        TX_nodes['InstrIdNode'].text = payment['instr_id']
    ...
    def _add_non_batch(self, TX_nodes, PmtInf_nodes):
        ...
        TX_nodes['OthrNode'].append(TX_nodes['Id_Othr_Node'])
        TX_nodes['SchmeNmNode'].append(TX_nodes['PrtryNode'])
        TX_nodes['OthrNode'].append(TX_nodes['SchmeNmNode'])
        TX_nodes['PrvtIdNode'].append(TX_nodes['OthrNode'])
        TX_nodes['Id_CdtrSchmeId_Node'].append(TX_nodes['PrvtIdNode'])
        TX_nodes['CdtrSchmeIdNode'].append(TX_nodes['Id_CdtrSchmeId_Node'])
